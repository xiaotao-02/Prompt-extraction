...
若在 `description.zh.md` / `description.en.md` 增补了商店页 FAQ（例如「增强型安全浏览」安装提示），改完后请到 Chrome Web Store 后台对应语言的 **Description** 字段整段替换；详见 [`CHECKLIST.md`](CHECKLIST.md) 第 9 节。
